...
static const struct Testsuite
{
	...
	TEST_FUNC(test_gl_pixel_color,			   					0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_gl_pixel_light_model_ambient,				0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_gl_pixel_material_emission,					0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_gl_pixel_light_ambient,						0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_gl_pixel_light_ambient_backside,				0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_gl_pixel_material_diffuse,	    			0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_gl_pixel_material_diffuse_backside,			0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_gl_pixel_material_diffuse_backside_clamp,	0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_gl_pixel_light_ambient_attenuation,			0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_gl_pixel_material_diffuse_attenuation,		0, TEST_FLAGS_NO_BENCHMARK),
